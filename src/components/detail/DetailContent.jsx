...
const DetailContent = (props) => {
  ...
  return (
    <div className="px-10">
      <div className={styles.detailContent}>
        ...
        <div className={styles.itemsTop}>
          <div className="flex items-center justify-start mt-5 lg:mt-0">
            <div className={styles.itemsTopInfor}>
              <img
                className="w-20 h-20 object-cover object-center rounded-full"
                src={require("../../assets/avatar/hoangNam.jpg")}
                alt="...."
              />
          ...
          <div className="text-right mr-10 mt-5 lg:mt-0">
            <div className={styles.itemsTopInfor} id={styles.rate}>
      ...
      <div>
        <h2 className="mt-10 text-xl font-medium capitalize mb-5">
          Những gì bạn sẽ học
        </h2>
        <Row>
