        ...
        <div className="container mx-auto">
            <div className='flex items-center w-full'>
                <div className='mr-5 lg:mr-10 text-center'>
                    <h1 className='text-yellow-500 text-5xl lg:text-6xl font-bold'>10</h1>
                    <p className='font-semibold text-xl'>NGÀY</p>
                </div>

                <div className='mr-5 lg:mr-10 mr-10 text-center'>
                    <h1 className='text-orange-500 text-5xl lg:text-6xl font-bold'>20</h1>
                    <p className='font-semibold text-xl'>GIỜ</p>
                </div>

                <div className='mr-5 lg:mr-10 mr-10 text-center'>
                    <h1 className='text-pink-500 text-5xl lg:text-6xl font-bold'>30</h1>
                    <p className='font-semibold text-xl' >PHÚT</p>
                </div>
                <div className='text-center'>
                    <h1 className='text-purple-500 text-5xl lg:text-6xl font-bold'>40</h1>
            ...
            <div className={styles.eventText}>
                ...
                <p className='font-semibold text-xl text-yellow-500 '>10 - 31 THÁNG 8, 2023, VIỆT NAM</p>
            </div>
        </div>
    </div>
  )
